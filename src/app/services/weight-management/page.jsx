...
export const generateMetadata = () => {
  return {
    ...
    keywords:
      "medical weight loss program Georgia, weight management clinic near me, physician-supervised weight loss Georgia, GLP-1 weight loss, weight management program, FDA-approved weight loss, sustainable weight loss, appetite control, metabolism booster, BMI over 30, obesity treatment, VitalCare Health, weight loss clinic Peachtree GA, lose weight with GLP-1, obesity-related disease prevention, body mass index calculator, medical weight loss program",
