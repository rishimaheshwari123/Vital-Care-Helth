...
export const generateMetadata = () => {
  return {
    ...
    keywords:
      "diabetes management doctor Georgia, diabetes management doctor Georgia, high blood pressure treatment Georgia, cholesterol check near me, high blood pressure treatment Georgia, cholesterol check near me, diabetes management, blood sugar testing, insulin therapy, continuous glucose monitoring, CGM, diabetes medication, nutrition counseling, diabetes care Peachtree GA, VitalCare Health, diabetes treatment, online diabetes follow-up",
