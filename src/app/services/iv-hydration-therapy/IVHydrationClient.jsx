      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div
            ...
            style={{
              animationDelay: "1s",
              transform: `translateY(${parallaxBg * 0.2}px)`,
            }}
          ></div>
        </div>
        ...
        >
          ...
          <h2
            className="text-3xl md:text-5xl font-extrabold text-black mt-2 animate-slide-up-fade"
            style={{ animationDelay: "100ms" }}
          >
            IV Hydration Therapy
          </h2>
          <p
            className="text-gray-600 mt-4 text-base md:text-lg leading-relaxed animate-slide-up-fade"
            style={{ animationDelay: "200ms" }}
          >
            We're excited to offer IV Hydration Therapy to help you recover
            quickly and feel your best. This treatment replenishes fluids,
            electrolytes, and nutrients directly into your bloodstream for fast,
            effective results.
          </p>
          ...
          <div className="mt-6 space-y-3">
            {[
              {
                icon: <FaBolt />,
                text: "Relieve dehydration and fatigue",
                delay: "300ms",
              },
              {
                icon: <FaHeart />,
                text: "Support recovery from illness or workouts",
                delay: "400ms",
              },
              {
                icon: <FaShieldAlt />,
                text: "Boost energy and overall wellness",
                delay: "500ms",
              },
            ].map((item, index) => (
              <div
              ...
              >
                ...
                <p className="text-gray-700 font-medium group-hover:text-[#0097a3] transition-colors duration-300">
                  {item.text}
                </p>
              </div>
            ))}
        ...
        >
          <div className="group relative rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 hover:rotate-2 transition-all duration-500">
            <Image
              ...
              width={500}
              height={400}
              className="w-[600px] transition-transform duration-700 group-hover:scale-110"
            />
            {/* Shine effect */}
          ...
          >
            <div className="absolute inset-0 flex items-center justify-center p-10">
              <div className="relative w-full h-full max-w-md">
                ...
                <div
                  className="absolute top-10 left-10 w-3 h-3 bg-[#00BFB3] rounded-full animate-bounce"
                  style={{ animationDelay: "0s" }}
                ></div>
                <div
                  className="absolute top-20 right-20 w-2 h-2 bg-[#1abbc4] rounded-full animate-bounce"
                  style={{ animationDelay: "0.5s" }}
                ></div>
                <div
                  className="absolute bottom-20 left-20 w-4 h-4 bg-[#00BFB3] rounded-full animate-bounce"
              ...
              <ul className="space-y-6">
                {[
                  ...
                  >
                    ...
                    <span className="text-lg group-hover:text-[#00BFB3] transition-colors duration-300">
                      {benefit}
                    </span>
                  </li>
                ))}
            ...
            {[
              {
                icon: "⚡",
                title: "Fast Results",
                desc: "Direct delivery into your bloodstream means immediate absorption and faster relief compared to oral hydration methods.",
                delay: 0,
              },
              {
                icon: "💪",
                title: "Enhanced Recovery",
                desc: "Perfect for post-workout recovery, illness recovery, or combating the effects of dehydration from travel or heat.",
                delay: 100,
              },
              {
                icon: "🎯",
                title: "Customized Treatment",
                desc: "Our experienced medical team tailors each IV therapy session to your specific needs and health goals.",
                delay: 200,
              },
            ].map((benefit, index) => (
              <div
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-xl font-bold text-black mb-3 group-hover:text-[#0097a3] transition-colors duration-300">
                    {benefit.title}
                  </h4>
      ...
      >
        <div className="absolute inset-0 opacity-5">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle, #0097a3 1px, transparent 1px)",
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Experience a seamless consultation process designed for your
              comfort and care
            </p>
          </div>
      ...
      <section className="bg-white py-16 px-5 md:px-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-lg mb-8">
            Walk in today or call to learn more about how IV Hydration Therapy
          ...
          <div className="mt-8 p-6 bg-[#f0fffe] rounded-xl">
            <p className="text-gray-700 font-medium">
              📍 <strong>Location:</strong> 8 Eastbrook Bend B, Peachtree City,
              GA 30269
            </p>
            <p className="text-gray-700 mt-2">
              <strong>Hours:</strong> Mon-Fri: 9am-7pm | Sat: 9am-4pm | Sun:
              Closed
            </p>
          </div>
        </div>
