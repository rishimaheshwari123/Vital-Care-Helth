          ...
          <div className="main items-center grid gap-5 lg:grid-cols-2">
            ...
            <div className="first grid gap-4 p-4 md:gap-6 md:p-8">
              ...
              <p className="text-sm md:text-xl">
                ...
                providing comprehensive health care solutions to our community.
                Our commitment to excellence and patient-centered care has been
                the driving force behind our journey.
              </p>
              <p className="text-sm md:text-xl">
                We are passionate about making a positive impact on the lives of
                our patients. Through continuous improvement and a
