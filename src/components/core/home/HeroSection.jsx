...
// CSS for gradient animation (If not already in global CSS)
/*
...
export default function HeroSection() {
  ...
  const [currentSlide, setCurrentSlide] = useState(0); // Kept for carousel logic if used
  // const [scrollY, setScrollY] = useState(0); // Removed scroll state
  ...
  useEffect(() => {
    ...
    // Removed: Parallax scroll effect (handleScroll and event listener)
  ...
  // Removed: Parallax scroll calculations (parallaxBg, parallaxContent, parallaxFloating)

  // Mouse parallax effect - Kept as it is internal
  const mouseParallaxX = (mousePosition.x - 0.5) * 20;
  const mouseParallaxY = (mousePosition.y - 0.5) * 20;

  return (
    // min-h-screen to maintain height, removed overflow-hidden to allow page scroll outside this component
    <div ref={heroRef} className="min-h-screen relative">
      {/* Background Image with Advanced Gradient Overlay & FIXED Position (removed transform) */}
      <div
        className="absolute inset-0 -z-10 transition-transform duration-100 ease-out"
        // Removed: Parallax scroll style: transform: translateY(${parallaxBg}px) scale(1.1)
        style={{
          transform: `scale(1.1)`,
        }}
      >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            // Removed: parallaxFloating from translateY
            transform: `translate(${mouseParallaxX * 0.5}px, ${
              mouseParallaxY * 0.5
            }px) scale(1)`, // Removed scrollY scale logic
          }}
        ></div>
        <div
          ...
          style={{
            animationDelay: "2s",
            // Removed: parallaxFloating from translateY
            transform: `translate(${-mouseParallaxX * 0.3}px, ${
              -mouseParallaxY * 0.3
            }px) scale(1)`, // Removed scrollY scale logic
          }}
        ></div>
        <div
          ...
          style={{
            animationDelay: "1s",
            // Removed: scrollY scale logic
            transform: `translate(-50%, -50%) translate(${mouseParallaxX}px, ${mouseParallaxY}px) scale(1)`,
          }}
        ></div>
      </div>

      {/* Main Content Container - Removed Parallax Transform */}
      <div
        className="relative z-10 min-h-screen flex items-center transition-transform duration-100 ease-out"
        // Removed: Parallax scroll style: transform: translateY(${parallaxContent}px)
      >
          ...
          <div className="lg:hidden flex flex-col items-center text-center space-y-8">
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                >
                  <p className="text-[#00BFB3] font-bold text-sm">
              ...
              >
                Experience compassionate, comprehensive healthcare with same-day
                appointments and expert medical professionals dedicated to your
                wellness.
              </p>
            </div>
            ...
            >
              <Link
                ...
                className="group relative overflow-hidden flex items-center justify-center gap-3 px-8 py-5 w-full text-lg font-extrabold text-white bg-gradient-to-r from-[#00BFB3] via-[#1abbc4] to-[#00BFB3] rounded-2xl shadow-2xl hover:shadow-[0_20px_60px_rgba(0,191,179,0.6)] transform hover:scale-105 transition-all duration-500 border-2 border-white/20 hover:border-white/40"
                style={{
              ...
              >
                <span className="relative z-10 flex items-center gap-3">
                  ...
                  <span className="text-center group-hover:tracking-wider transition-all duration-300">
              ...
              <Link
                href="/membership"
                className="group relative flex items-center justify-center gap-3 px-8 py-5 w-full text-lg font-bold text-[#0097a3] bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl hover:shadow-[0_20px_60px_rgba(255,255,255,0.8)] transform hover:scale-105 transition-all duration-500 border-2 border-white/50 hover:border-[#00BFB3] overflow-hidden"
              >
                <span className="relative z-10 group-hover:text-[#00BFB3] transition-colors duration-300">
                  Annual Membership
                </span>
                <span className="relative z-10 text-2xl font-extrabold text-[#EF4444] animate-pulse group-hover:scale-125 group-hover:rotate-12 transition-transform duration-500">
                  $399
                </span>
              ...
              <div className="relative p-5">
                <div className="flex items-start gap-3 mb-3">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-gradient-to-r from-[#FDB913] to-[#f59e0b] backdrop-blur-sm rounded-2xl flex items-center justify-center text-2xl animate-bounce">
                      💧
                    </div>
                  </div>
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <span className="bg-gradient-to-r from-[#FDB913] to-[#f59e0b] text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg border border-white/20 animate-pulse">
                        ✨ NOW AVAILABLE
                      </span>
                    ...
                    <p className="text-white/95 text-sm leading-relaxed font-medium">
                      Fast, effective treatment to replenish fluids,
          ...
          <div className="hidden lg:grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                >
                  <p className="text-[#00BFB3] font-bold text-base">
                    🏥 Locally Owned & Operated
                  </p>
                </div>
                ...
                >
                  Experience compassionate, comprehensive healthcare with
                  same-day appointments and expert medical professionals
              ...
              >
                <div className="group relative flex items-center gap-3 bg-white/15 backdrop-blur-md px-6 py-4 rounded-2xl border border-white/20 shadow-lg hover:bg-white/30 hover:scale-105 hover:shadow-[0_10px_40px_rgba(0,191,179,0.4)] transition-all duration-500 overflow-hidden">
            ...
            >
              ...
              >
                ...
                <span className="text-3xl font-extrabold text-[#EF4444] animate-pulse">
                  $399
                </span>
              ...
              >
                ...
                <div className="relative p-6">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0">
                      <div className="w-14 h-14 bg-gradient-to-r from-[#FDB913] to-[#f59e0b] backdrop-blur-sm rounded-2xl flex items-center justify-center text-3xl animate-bounce">
                        💧
                      </div>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="bg-gradient-to-r from-[#FDB913] to-[#f59e0b]  text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg border border-white/20 ">
                          NOW AVAILABLE
                        </span>
                        <span className="text-white font-extrabold text-lg drop-shadow-lg">
                          IV Hydration Therapy
